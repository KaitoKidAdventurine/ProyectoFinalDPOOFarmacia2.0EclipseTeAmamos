...
public class PrincipalAdmin extends JFrame 
{
	...
	public PrincipalAdmin() 
	{
		...
		scrollPane.setBounds(0, 395, 1005, 255);
		...
		lblFechaDeProduccin.setBounds(681, 77, 139, 20);
		...
		lblFechaDeVencimiento.setBounds(681, 142, 139, 20);
		    ...
		    public void mouseClicked(MouseEvent e) {
		        try {
		            ...
		            Medicamento nuevoMed = new Medicamento(
		                ...
		                txtCantidad, fechaProd, fechaVenc
		            );

		            // Agregar a la farmacia
		            Farmacia farmacia = Farmacia.obtenerInstancia().agregarMedicamento(
		                txtNombreComun, txtNombreCientifico, txtPresentacion,
		                txtPrecio, txtTipo, txtFortaleza, txtTemperatura,
		                txtCantidad, txtFechaProduccion, txtFechaVencimiento
		            );

		            // Actualizar tabla
		            medicamentoTableModel.actualizar(farmacia.obtenerMedicamentos());

		            // Mensaje de éxito
		            JOptionPane.showMessageDialog(null, 
		                "Medicamento agregado exitosamente!\n" +
		                "Código generado: " + nuevoMed.getCodigo(), 
		...
		panel_12.setBounds(681, 209, 245, 59);
